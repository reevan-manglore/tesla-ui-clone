...
function ProductView({ bgImage, hedding, linkText, linkHref, subText, primaryButtonText, secondoryButtonText }) {
  return (
    <section className="h-screen flex justify-center items-center  bg-center bg-cover bg-no-repeat lg:bg-cover  snap-start" style={{ backgroundImage: `url('${bgImage}')` }}>
      <article className='h-3/4  w-full  flex flex-col justify-between items-center '>
        ...
        <div className=' flex flex-col  w-3/4 lg:flex-row  justify-center items-center max-md:space-y-6 lg:space-x-10 '>
